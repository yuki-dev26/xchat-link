...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DXfIDaxL.mjs");
...
var manifest = { "915c8edc13b3cf2cecc93b6e797ead74fc470d6234d9302c89a750f0d7ec2e55": {
	functionName: "resolveXUser_createServerFn_handler",
	importer: () => import("./resolve-x-user-DXzmNJLo.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-C29olDDK.mjs").then((n) => n.t),
